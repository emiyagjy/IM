...
//    iPhoneXMPPAppDelegate *appDelegate = [iPhoneXMPPAppDelegate sharedAppDelegate];
...
- (BOOL)connect
{
    ...
    [xmppStream setMyJID:[XMPPJID jidWithUser:myJID domain:kXMPPHost resource:@"ios"]];
	password = myPassword;
...
//        [msg setMessageFrom:displayName];
