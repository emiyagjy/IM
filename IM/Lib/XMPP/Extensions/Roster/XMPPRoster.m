...
- (void)addUser:(XMPPJID *)jid withNickname:(NSString *)optionalName
{
	...
	[xmppStream sendElement:[XMPPPresence presenceWithType:@"subscribe" to:[jid bareJID] withId:[xmppStream generateUUID]]];
}
...
- (void)subscribePresenceToUser:(XMPPJID *)jid
{
	...
	XMPPPresence *presence = [XMPPPresence presenceWithType:@"subscribe" to:[jid bareJID] withId:[xmppStream generateUUID]];
...
- (void)unsubscribePresenceFromUser:(XMPPJID *)jid
{
	...
	XMPPPresence *presence = [XMPPPresence presenceWithType:@"unsubscribe" to:[jid bareJID] withId:[xmppStream generateUUID]];
	[xmppStream sendElement:presence];
}
...
- (void)revokePresencePermissionFromUser:(XMPPJID *)jid
{
	...
	XMPPPresence *presence = [XMPPPresence presenceWithType:@"unsubscribed" to:[jid bareJID] withId:[xmppStream generateUUID]];
	[xmppStream sendElement:presence];
}
...
- (void)acceptPresenceSubscriptionRequestFrom:(XMPPJID *)jid andAddToRoster:(BOOL)flag
{
	...
	XMPPPresence *presence = [XMPPPresence presenceWithType:@"subscribed" to:[jid bareJID] withId:[xmppStream generateUUID]];
	[xmppStream sendElement:presence];
...
- (void)xmppStream:(XMPPStream *)sender didReceivePresence:(XMPPPresence *)presence
{
	...
	if ([[presence type] isEqualToString:@"subscribe"])
	{
		...
		if (knownUser && [self autoAcceptKnownPresenceSubscriptionRequests])
		{
			...
			XMPPPresence *response = [XMPPPresence presenceWithType:@"subscribed" to:userJID withId:[xmppStream generateUUID]] ;
